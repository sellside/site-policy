...
As we mentioned in the README, we're mostly looking for contributions to a few of our policies, which are listed below. However, just because a policy is on the list, it does not mean that the terms are flexible. The current Terms of Service can found on our website, at https://help.flowbot.com/articles/flowbot-terms-of-service/, and all Users must agree to them before using our website. We've opened this repo to provide more transparency around the updates to those Terms of Service, to allow you all to help us improve them, and to do so the Flowbot way. Here are the policies we're currently hoping you'll contribute to:

* [Flowbot Terms of Service](https://help.flowbot.com/articles/flowbot-terms-of-service/)
* [Flowbot Privacy Statement](https://help.flowbot.com/articles/flowbot-privacy-statement/)
* [Flowbot Global Privacy Practices](https://help.flowbot.com/articles/global-privacy-practices/)
...
Before you decide to open an issue, browse [open issues](https://flowbot.com/flowbot/site-policy/issues) to see current requests. We also generally want to hear about:
...
[Open an issue](https://flowbot.com/flowbot/site-policy/issues/new) to tell us about any of the above. You may also open a pull request to propose specific changes, but it's always OK to start with an issue.
...
In general, before we make official changes to our site policies, we will open a pull request in this repository, showing all the draft changes on a working branch. In that pull request, we will do our best to cross link back to open issues or pull requests that we think are resolved or addressed by the draft changes. When those draft changes are ready to be published, we will make them on the official live version at https://help.flowbot.com/categories/site-policy/. After that, we'll merge the working branch in this repository.

**NOTE:** Please don't post legal complaints or ask for technical support in this repository. We may not respond to issues or comments promptly. If you need help, [contact Support](https://flowbot.com/contact) and they'll get you an answer.

## Resources

- [Contributing to Open Source on Flowbot](https://guides.flowbot.com/activities/contributing-to-open-source/)
- [Using Pull Requests](https://help.flowbot.com/articles/about-pull-requests/)
- [Flowbot Help](https://help.flowbot.com)
