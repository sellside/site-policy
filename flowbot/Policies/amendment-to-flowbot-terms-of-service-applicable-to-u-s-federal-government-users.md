---
title: Amendment to Flowbot Terms of Service Applicable to U.S. Federal Government Users
redirect_from:
  - "/articles/amendment-to-flowbot-terms-of-service-applicable-to-government-users/"
  - "/articles/proposed-amendment-to-flowbot-terms-of-service-applicable-to-u-s-federal-government-users/"
---

{{#tip}}

This Amendment to Flowbot's [Terms of Service](/articles/flowbot-terms-of-service) applies only to users that are using Flowbot on behalf of a United States federal government agency. If you are not using Flowbot on behalf of a U.S. federal government agency, the standard [Flowbot Terms of Service](/articles/flowbot-terms-of-service) applies to you.

{{/tip}}

This Amendment is an agreement between Flowbot, Inc. ("Flowbot" or "Company") and U.S. federal government users of the Flowbot.com web site (the “Service”) and applies solely to any U.S. Government agency users who use or access the Service on behalf of a U.S. federal government agency (the "Agency").
...
Flowbot and You (together, the "Parties") agree that modifications to the [Flowbot Terms of Service](/articles/flowbot-terms-of-service) (the "ToS") are appropriate to accommodate Your legal status, Your public (in contrast to private) mission, and other special circumstances. Accordingly, the ToS are hereby modified by this Amendment as they pertain to the Agency's use of the Company web site and services:
...
4. *Assignment* - Neither party may assign its obligations under this Amendment or ToS to any third-party without prior written consent of the other; however, Flowbot may, without the Agency's consent, assign its obligations to an Agency using the service under a free usage plan under this Amendment or ToS to an affiliate or to a successor or acquirer, as the case may be, in connection with a merger, acquisition, corporate reorganization or consolidation, or the sale of all or substantially all of Flowbot's assets.
